...
This project focuses on detecting intracranial aneurysms using medical brain images.  
A trained deep learning model is used to analyze images and determine whether an aneurysm is present.
